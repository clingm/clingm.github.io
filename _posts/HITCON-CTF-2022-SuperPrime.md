...
\begin{aligned}
n_2 &= p_2*p_3 \\
&=(a_{01}+a_{11}*10+a_{21}*10^2+\cdots+)*(a_{02}+a_{12}*10+a_{22}*10^2+\cdots+)
\end{aligned}
$$
$$
\begin{aligned}
...
[offical writeup](https://github.com/maple3142/My-CTF-Challenges/tree/master/HITCON%20CTF%202022/Superprime)
