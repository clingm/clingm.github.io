...
$$
\lambda \equiv \begin{cases}
\frac{y_1-y_2}{x_1-x_2} & if x_1 \not\equiv x_2 \pmod{p} \\ \\
\frac{3x_1^2 + a}{2y_1} & ifx1=x2 \pmod{p}
\end{cases}
$$
...
$$
|E_p(a,b)|=p+1+\alpha，|\overline{E_p(a,b)}|=p+1-\alpha \\
|E_q(a,b)|=p+1+\beta，|\overline{E_q(a,b)}|=p+1-\beta
$$
