...
date: 2022-11-22 23:44:29
tags: [Lattice, paper]
categories: Crypto
katex: true
cover: https://academy.bit2me.com/wp-content/uploads/2019/04/42_ECDSA.webp
---
...
$$
\begin{aligned}
MSB_{\alpha,k}(t_i) &= MSB_k(\alpha \cdot t_i\ mod\ n) \\
&= MSB_k(d\cdot s^{-1}\cdot r) \\
&= MSB_k(-a_i + k) \\
&= n-a_i
\end{aligned}
$$
...
& \vdots & & & \cdots & \\
0 & 0 & 0 & \cdots & n & 0 \\
t_{0} & t_{1} & t_{2} & \cdots & t_{m-1} & 1 / n
\end{array}\right]
$$
...
& \vdots & & & \vdots & & \\
0 & 0 & 0 & \cdots & n & 0 & 0 \\
t_{0} & t_{1} & t_{2} & \cdots & t_{m-1} & 2^{\ell} / n & 0 \\
a_{0} & a_{1} & a_{2} & \cdots & a_{m-1} & 0 & 2^{\ell}
\end{array}\right]
$$
...
- [Intended Solution to NHP in GxzyCTF 2020](https://blog.soreatu.com/posts/intended-solution-to-nhp-in-gxzyctf-2020/#writeup) by Soreat_u
